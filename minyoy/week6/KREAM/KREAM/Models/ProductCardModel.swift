...
extension ProductCardModel {
    static func dummy() -> [ProductCardModel] {
        return [
            ...
            ProductCardModel(productImage: .item, transaction: "13.1", brand: "Matin Kim", productTitle: "Matin Kim Logo Coating Jumper", productPrice: "228,000", color: UIColor(red: 237/255, green: 243/255, blue: 236/255, alpha: 1)),
        ]
    }
}
