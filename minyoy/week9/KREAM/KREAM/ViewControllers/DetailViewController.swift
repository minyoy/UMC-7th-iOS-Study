...
class DetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let data = receivedData {
            detailView.image.kf.setImage(with: URL(string: data.productImageURL))
            detailView.nameEn.text = data.nameEn
            detailView.nameKo.text = data.nameKo
    ...
    @objc private func goModal() {
        ...
        buyvc.receivedData = receivedData
